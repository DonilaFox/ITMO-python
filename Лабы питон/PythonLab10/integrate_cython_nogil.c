...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "integrate_cython_nogil",
        "sources": [
            "integrate_cython_nogil.pyx"
        ]
    },
    "module_name": "integrate_cython_nogil"
}
END: Cython Metadata */
...
#define __PYX_HAVE__integrate_cython_nogil
#define __PYX_HAVE_API__integrate_cython_nogil
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "integrate_cython_nogil" */
static double __pyx_f_22integrate_cython_nogil_integrate_cos_cython_nogil(double, double, int, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "integrate_cython_nogil"
extern int __pyx_module_is_main_integrate_cython_nogil;
int __pyx_module_is_main_integrate_cython_nogil = 0;

/* Implementation of "integrate_cython_nogil" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_22integrate_cython_nogil_integrate_cos_cython_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_kp_u_integrate_cython_nogil_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_integrate_cos_cython_nogil __pyx_string_tab[8]
#define __pyx_n_u_integrate_cython_nogil __pyx_string_tab[9]
...
#define __pyx_kp_b_iso88591_wc_q_a_r_1_a_A_A_a_a_Cr_U_1_Bb __pyx_string_tab[22]
...
static PyObject *__pyx_pw_22integrate_cython_nogil_1integrate_cos_cython_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_22integrate_cython_nogil_integrate_cos_cython_nogil(double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_acc;
  double __pyx_v_x;
  int __pyx_v_i;
  double __pyx_v_tmp;
  int __pyx_v_is_reversed;
  double __pyx_v_step;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "integrate_cython_nogil.pyx":13
 *     : ^{/2} cos(x) dx = 1, ^ cos(x) dx = 0.
 *     """
 *     if n_iter <= 0:             # <<<<<<<<<<<<<<
 *         return -10.0  #    (   GIL)
 * 
...
*/
  /*else*/ {
    __pyx_v_is_reversed = 0;
  }
  __pyx_L4:;

  /* "integrate_cython_nogil.pyx":31
 *         is_reversed = False
 * 
 *     cdef double step = (b - a) / n_iter             # <<<<<<<<<<<<<<
 * 
 ...
 * 
*/
  if (__pyx_v_is_reversed) {

    /* "integrate_cython_nogil.pyx":38
 * 
 *     if is_reversed:
 *         acc = -acc             # <<<<<<<<<<<<<<
 * 
...
PyDoc_STRVAR(__pyx_doc_22integrate_cython_nogil_integrate_cos_cython_nogil, "\n    \320\230\320\275\321\202\320\265\320\263\321\200\320\270\321\200\321\203\320\265\321\202 cos(x) \320\275\320\260 [a, b] \320\274\320\265\321\202\320\276\320\264\320\276\320\274 \320\273\320\265\320\262\321\213\321\205 \320\277\321\200\321\217\320\274\320\276\321\203\320\263\320\276\320\273\321\214\320\275\320\270\320\272\320\276\320\262 \320\261\320\265\320\267 \321\203\320\264\320\265\321\200\320\266\320\260\320\275\320\270\321\217 GIL.\n    \320\230\320\267\320\262\320\265\321\201\321\202\320\275\320\276: \342\210\253\342\202\200^{\317\200/2} cos(x) dx = 1, \342\210\253\342\202\200^\317\200 cos(x) dx = 0.\n    ");
static PyMethodDef __pyx_mdef_22integrate_cython_nogil_1integrate_cos_cython_nogil = {"integrate_cos_cython_nogil", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_22integrate_cython_nogil_1integrate_cos_cython_nogil, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_22integrate_cython_nogil_integrate_cos_cython_nogil};
static PyObject *__pyx_pw_22integrate_cython_nogil_1integrate_cos_cython_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("integrate_cos_cython_nogil (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_cos_cython_nogil", 0) < (0)) __PYX_ERR(0, 5, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_cos_cython_nogil", 1, 3, 3, i); __PYX_ERR(0, 5, __pyx_L3_error) }
      }
    ...
    __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_cos_cython_nogil", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("integrate_cython_nogil.integrate_cos_cython_nogil", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_22integrate_cython_nogil_integrate_cos_cython_nogil(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_22integrate_cython_nogil_integrate_cos_cython_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("integrate_cos_cython_nogil", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_22integrate_cython_nogil_integrate_cos_cython_nogil(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L1_error)
...
static int __pyx_pymod_exec_integrate_cython_nogil(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_integrate_cython_nogil},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_integrate_cython_nogil(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_integrate_cython_nogil(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_integrate_cython_nogil(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'integrate_cython_nogil' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "integrate_cython_nogil" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit